...
namespace Project.Models
{
    public class UserInfo : ApplicationUser
    {
        ...
        [Display(Name = "Birthdate"), Column("Bdate"), DisplayFormat(DataFormatString = "{0:MM-dd-yyyy}", ApplyFormatInEditMode = true)]
        public DateTime? Birthdate { get; set; }

        [Display(Name = "Is Married")]
        public bool? IsMarried { get; set; }

        [Remote("IsFull", "Main", HttpMethod = "POST", ErrorMessage = "The department is full. Please, choose a another department."), Column("Dp_Id"), ForeignKey("Department")]
